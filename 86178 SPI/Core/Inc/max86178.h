...
#define Set_MEAS1_DRVA   			(unit8_t)0x0<<3
...
#define Set_MEAS1_PPG_TINT			(unit8_t)0x3<<3
#define Set_MEAS1_LED_RGE			(unit8_t)0x3
#define Set_MEAS1_PD_SETLNG			(unit8_t)0x1<<6 |Set_MEAS1_LED_RGE
#define Set_MEAS1_LED_SETLNG		(unit8_t)0x1<<2 |Set_MEAS1_PD_SETLNG
#define Set_MEAS1_DRVA_PA			(unit8_t)0x02
#define Set_MEAS1_DRVB_PA  			(unit8_t)0x00
#define Set_MEAS1_PD1_SEL  			(unit8_t)0x2
#define Set_MEAS1_PD3_SEL  			(unit8_t)0x3<<2

//MEASUREMENT 2  CONFIGURATION
#define Set_MEAS2_AMB				(unit8_t)0x00
#define Set_MEAS2_DRVA   			(unit8_t)0x1<<3
#define Set_MEAS2_AVER				(unit8_t)0x3					  //for number of led pulses equal to 8
#define Set_MEAS2_PPG1_ADC_RGE		(unit8_t)0x2
#define Set_MEAS2_PPG2_ADC_RGE		(unit8_t)0x2<<4 |Set_MEAS2_PPG1_ADC_RGE
#define Set_MEAS2_PPG_TINT			(unit8_t)0x3<<3
#define Set_MEAS2_LED_RGE			(unit8_t)0x3
#define Set_MEAS2_PD_SETLNG			(unit8_t)0x1<<6 |Set_MEAS2_LED_RGE
#define Set_MEAS2_LED_SETLNG		(unit8_t)0x1<<2 |Set_MEAS2_PD_SETLNG
#define Set_MEAS2_DRVA_PA			(unit8_t)0x02
#define Set_MEAS2_DRVB_PA  			(unit8_t)0x00
#define Set_MEAS2_PD2_SEL  			(unit8_t)0x0<<2

//MEASUREMENT 3  CONFIGURATION
#define Set_MEAS3_AMB				(unit8_t)0x00
#define Set_MEAS3_DRVB              (unit8_t)0x2<<3
#define Set_MEAS3_AVER				(unit8_t)0x3					  //for number of led pulses equal to 8
#define Set_MEAS3_PPG1_ADC_RGE		(unit8_t)0x2
#define Set_MEAS3_PPG2_ADC_RGE		(unit8_t)0x2<<4 |Set_MEAS3_PPG1_ADC_RGE
#define Set_MEAS3_PPG_TINT			(uint8_t)0x3<<3
#define Set_MEAS3_LED_RGE			(uint8_t)0x3
#define Set_MEAS3_PD_SETLNG			(uint8_t)0x1<<6 |Set_MEAS3_LED_RGE
#define Set_MEAS3_LED_SETLNG		(uint8_t)0x1<<2 |Set_MEAS3_PD_SETLNG
#define Set_MEAS3_DRVA_PA			(uint8_t)0x02
#define Set_MEAS3_DRVB_PA  			(uint8_t)0x00
#define Set_MEAS3_PD2_SEL  			(uint8_t)0x2<<2

//MEASUREMENT 4  CONFIGURATION
#define Set_MEAS4_AMB				(uint8_t)0x00
#define Set_MEAS4_PPG1_ADC_RGE		(uint8_t)0x2
#define Set_MEAS4_PPG2_ADC_RGE		(uint8_t)0x2<<4 |Set_MEAS4_PPG1_ADC_RGE
#define Set_MEAS4_PPG_TINT			(uint8_t)0x3<<3
#define Set_MEAS4_PD1_SEL  			(uint8_t)0x2
#define Set_MEAS4_PD3_SEL  			(uint8_t)0x3<<4
