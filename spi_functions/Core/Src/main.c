...
int main(void)
{
	...
	uint32_t samples[600];
	uint32_t samples_p1_m1[60] = 0;
	uint32_t samples_p2_m1[60] = 0;
	uint32_t samples_p1_m2[60] = 0;
	uint32_t samples_p2_m2[60] = 0;
	uint32_t samples_p1_m3[60] = 0;
	uint32_t samples_p2_m3[60] = 0;
